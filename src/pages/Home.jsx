    ...
    return (
        <div className="flex flex-col min-h-screen font-sans text-neutral-600">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <Reveal className="space-y-8 text-center lg:text-left">
                            ...
                            <div className="flex flex-wrap justify-center lg:justify-start gap-4">
                                <Link to="/contact" className="px-8 py-4 bg-[#D35400] text-white font-bold rounded shadow-lg hover:bg-[#A04000] transition-all transform hover:-translate-y-1">
                                    Book a Demo
                                </Link>
                                <Link to="/contact" className="px-8 py-4 bg-white text-slate-800 font-bold border-2 border-slate-200 rounded hover:border-[#D35400] hover:text-[#D35400] transition-all transform hover:-translate-y-1">
                                    Contact Us
                                </Link>
                            </div>
                        </Reveal>
            ...
            <section className="py-32 bg-white">
                <div className="container mx-auto px-8 lg:px-12">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <Reveal delay={0.1}>
                            <div className="group p-6 rounded-2xl bg-[#FDF2E9] border-2 border-[#D35400] hover:shadow-xl transition-all relative overflow-hidden text-center h-full">
                                <div className="w-16 h-16 mx-auto bg-white border-2 border-[#D35400] rounded-full flex items-center justify-center text-3xl mb-4 text-[#D35400] relative z-10 transition-transform group-hover:scale-110">
                                    🏫
                                </div>
                        ...
                        <Reveal delay={0.2}>
                            <div className="group p-6 rounded-2xl bg-[#D6EAF8] border-2 border-[#2980B9] hover:shadow-xl transition-all relative overflow-hidden text-center h-full">
                                <div className="w-16 h-16 mx-auto bg-white border-2 border-[#2980B9] rounded-full flex items-center justify-center text-3xl mb-4 text-[#2980B9] relative z-10 transition-transform group-hover:scale-110">
                                    🎓
                                </div>
                                <h3 className="text-xl font-bold text-slate-900 mb-3">
                                    College ERP
                        ...
                        <Reveal delay={0.3}>
                            <div className="group p-6 rounded-2xl bg-[#F4ECF7] border-2 border-[#8E44AD] hover:shadow-xl transition-all relative overflow-hidden text-center h-full">
                                <div className="w-16 h-16 mx-auto bg-white border-2 border-[#8E44AD] rounded-full flex items-center justify-center text-3xl mb-4 text-[#8E44AD] relative z-10 transition-transform group-hover:scale-110">
                                    🎯
                                </div>
                                <h3 className="text-xl font-bold text-slate-900 mb-3">
                                    Coaching Centers
                        ...
                        <Reveal delay={0.4}>
                            <div className="group p-6 rounded-2xl bg-[#EAFAF1] border-2 border-[#27AE60] hover:shadow-xl transition-all relative overflow-hidden text-center h-full">
                                <div className="w-16 h-16 mx-auto bg-white border-2 border-[#27AE60] rounded-full flex items-center justify-center text-3xl mb-4 text-[#27AE60] relative z-10 transition-transform group-hover:scale-110">
                                    💻
                                </div>
                                <h3 className="text-xl font-bold text-slate-900 mb-3">
                                    eLearning Platform
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
                        ...
                        <Reveal delay={0.2} className="order-1 lg:order-2">
                            <img
                                ...
                                alt="Feature 1"
                                className="rounded-xl shadow-lg w-full hover:shadow-2xl transition-shadow"
                            />
                        </Reveal>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            <Reveal key={i} delay={i * 0.1}>
                                <div className="bg-neutral-50 p-8 rounded-xl border border-neutral-100 relative h-full hover:shadow-lg transition-shadow">
            ...
            <section className="py-32 bg-black text-white">
                <Reveal className="container mx-auto px-8 lg:px-12 text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        <Link to="/contact" className="px-10 py-4 bg-brand-500 text-white font-bold rounded-lg shadow-lg hover:bg-brand-600 transition-all transform hover:scale-105">
                            Partner With Us
                        </Link>
                        <button className="px-10 py-4 bg-transparent border border-neutral-600 text-white font-bold rounded-lg hover:bg-neutral-800 transition-all transform hover:scale-105">
                            Talk to Expert
                        </button>
                    </div>
                </Reveal>
