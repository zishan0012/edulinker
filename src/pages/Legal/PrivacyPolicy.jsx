        ...
        <div className="container mx-auto px-8 lg:px-12 max-w-4xl">
          <Reveal>
            <div className="prose prose-slate lg:prose-lg mx-auto">
              ...
              <p className="text-neutral-600 mb-8">Welcome to Edulinkers. Your privacy and trust are paramount to us. This Privacy Policy document outlines our standards and policies regarding our AI-driven SaaS platform.</p>
