...
const ExamPlatform_Unacademy = () => {
  return (
    <div className="main-content">
        ...
        <div className="container mx-auto px-8 lg:px-12">
          <Reveal>
            <div className="max-w-4xl mx-auto text-center mb-16">
              ...
              <p className="text-lg text-neutral-600">Competitive Exam Platform is a ready-to-deploy platform solution that combines student engagement, teacher administration, and a robust AI engine into a single, scalable brandable package.</p>
            </div>
          ...
          <FeatureGrid 
            ...
            subtitle="What makes Competitive Exam Platform the benchmark for EdTech platforms."
            features={[
      ...
      <CTASection title="Launch Your Competitive Exam Platform Now" />
    </div>
  );
};

export default ExamPlatform_Unacademy;
