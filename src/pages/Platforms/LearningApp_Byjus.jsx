...
const LearningApp_Byjus = () => {
  return (
    <div className="main-content">
        ...
        <div className="container mx-auto px-8 lg:px-12">
          <Reveal>
            <div className="max-w-4xl mx-auto text-center mb-16">
              ...
              <p className="text-lg text-neutral-600">K-12 Learning App is a ready-to-deploy platform solution that combines student engagement, teacher administration, and a robust AI engine into a single, scalable brandable package.</p>
            </div>
          ...
          <FeatureGrid 
            ...
            subtitle="What makes K-12 Learning App the benchmark for EdTech platforms."
            features={[
      ...
      <CTASection title="Launch Your K-12 Learning App Now" />
    </div>
  );
};

export default LearningApp_Byjus;
