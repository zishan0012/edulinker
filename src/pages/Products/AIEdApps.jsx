...
const AIEdApps = () => {
  return (
    <div className="main-content">
      <HeroSection 
        title="AI Powered Educational Apps" 
          ...
          <Reveal>
            <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
              <div>
                ...
                <p className="text-lg text-neutral-600 mb-8">AI Powered Educational Apps is a cornerstone of our SaaS suite, providing institutions with the tools needed to manage operations efficiently while leveraging AI for superior educational outcomes.</p>
      ...
      <CTASection title="Get a Demo of AI Powered Educational Apps" />
    </div>
  );
};

export default AIEdApps;
