...
const AttendanceSystem = () => {
  return (
    <div className="main-content">
          ...
          <Reveal>
            <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
              <div>
                ...
                <p className="text-lg text-neutral-600 mb-8">Attendance Tracking System is a cornerstone of our SaaS suite, providing institutions with the tools needed to manage operations efficiently while leveraging AI for superior educational outcomes.</p>
      ...
      <CTASection title="Get a Demo of Attendance Tracking System" />
    </div>
  );
};
