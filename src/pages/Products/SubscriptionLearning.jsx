...
const SubscriptionLearning = () => {
  return (
    <div className="main-content">
      <HeroSection 
        title="Subscription Learning App" 
          ...
          <Reveal>
            <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
              <div>
                ...
                <p className="text-lg text-neutral-600 mb-8">Subscription Learning App is a cornerstone of our SaaS suite, providing institutions with the tools needed to manage operations efficiently while leveraging AI for superior educational outcomes.</p>
      ...
      <CTASection title="Get a Demo of Subscription Learning App" />
    </div>
  );
};

export default SubscriptionLearning;
