...
const CustomLMSDev = () => {
  return (
    <div className="main-content">
      <HeroSection 
        title="Custom LMS/SMS Development" 
        ...
        <div className="container mx-auto px-8 lg:px-12">
          <Reveal>
            <div className="max-w-3xl mb-16 mx-auto text-center">
              ...
              <p className="text-lg text-neutral-600">We provide end-to-end expertise in Custom LMS/SMS Development, specifically tailored for the education sector. Our teams combine domain knowledge with AI innovation to deliver world-class EdTech platforms.</p>
            </div>
          </Reveal>
