        ...
        <div className="container mx-auto px-8 lg:px-12">
          <Reveal>
            ...
            <div className="bg-brand-50 p-8 md:p-12 rounded-3xl border border-brand-100 mb-24">
              ...
              <p className="text-slate-900 font-medium leading-relaxed">By leveraging machine learning and predictive analytics, SaaS School Management automates routine tasks, provides deep insights into student performance, and creates a seamless experience for administrators and educators alike.</p>
            </div>
          </Reveal>
